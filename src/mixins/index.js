...
export default {
  computed: {
    ... mapState({
        winnings:   state => state.winning.winnings,
        lotterys:   state => state.lottery.lotterys,
        lotteryLocal:state => state.lotterylocal.lotteryLocal,
        chessTypes: state => state.chess.chessTypes,
        chesss:     state => state.chess.chesss,
      //  basic:      state => state.basic.basic,
        messages:   state => state.message.messages,
   }),   
 },
 created(){
     this.$store.dispatch('winning/getAllWinnings')
     this.$store.dispatch('lottery/getAllLotterys')
     this.$store.dispatch('lotterylocal/getAllLotteryLocals')
     this.$store.dispatch('chess/getAllChessTypes')
     this.$store.dispatch('chess/getAllChesss')
    // this.$store.dispatch('basic/getAllBasics')
     this.$store.dispatch('message/SOCKET_getAllMessages')
 },
 methods: { 
   ...mapMutations('basic', ['setData']),
    $total(config) {
