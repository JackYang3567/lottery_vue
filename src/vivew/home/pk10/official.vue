...
<main class="kd-body game game-p game-id-p game-official" v-if="Object.keys(list_data).length" style="background: #202044;">
    ...
    <transition name="height_change1">
        <div class="promptbox-wrapper prompt-in-game-rule sd115 prompt-gamerecords-official open-xiaoguo" style="position:static !important;" v-if="show_content" @click="show_content=!show_content">
                    ...
                    <table class="account__table" v-if="dayHistory">
                        ...
                        <tr v-for="v in dayHistory">
                            ...
                            <td class="primary-color" style="text-align: center;">
                                <span v-for="(ball_number,key) in v['content']"  :class="['lottery-ball solid pk10', ( 'ball'+parseInt(ball_number) ),'lottery-ball-official']" style="margin-left: 4px;margin-top: 4px;">{{ball_number}}</span>
    ...
    <div class="game-record-switch-wrapper" @click="show_content=!show_content">
  ...
  export default{
    ...
    methods: {
        getHistory(){
            ...
            _this.$getData({
                loading:true,
                url:'/api/home/home/getHistory-6',
...
//key1:'official_dwd',key2:'official_dwd_fs',content:[[0,1,2,3],[0,1,2,3]],single:10,odds:1,num:1
       ...
       getInfo(got){
           ...
           _this.data_post = 1;
           _this.$getData({
               url:'/api/home/lottery/getInfo=2',
...
.account__table>thead>tr>th{
    background: rgb(32, 32, 68);
    border-bottom: 1px solid #8ae5f7;
}
.account__table>tbody>tr>td:first-child{
    border-right-color: #8ae5f7;
}
.account__table>tbody>tr>td:first-child:before{
    background: #8ae5f7;
}
