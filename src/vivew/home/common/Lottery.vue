<template>
  <div id="app">
      <div class="for-zhe-zhao" v-if="show_history_div && !getRoom">
                    ...
                    <div class="show-code-for-expect">
                        ...
                        <template v-else>
                            <template v-if="history.content">
                                <span data-v-7ce3e059="" class="spansAll" v-for="i in history.content">{{i}}</span>
                            </template>
                            <template v-else>
...
<!--:style="{'overflow':!show_history_div?'hidden !improtant':''}"-->
...
<style scoped>
    ...
    /*.for-height-change-enter,.for-height-change-leave-to{*/
        /*height: 0px;*/
    /*}*/
    /*.for-height-change-enter-active,.for-height-change-leave-active{*/
        /*transition: 1.5s;*/
    /*}*/
    /*.for-height-change-enter-to.for-height-change-leave{*/
        /*height: 45%;*/
    /*}*/
    .showfangxiang{
        width: 15px;
