<template>
  <div id="app">
    ...
    <form class="kd-form kd-container" v-else>
      ...
      <div class="kd-field"><label for="nick_name_in_bank_info" class="kd-field-title">身份证号码：<i class="text_msg"></i></label>
        <div class="kd-textinput text">
          <input v-if="phone == ''" type="text" v-model="form.phone"  placeholder="请输入身份证号码后八位">
