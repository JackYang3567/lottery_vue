...
const Router = new VueRouter({
  routes: [{
    ...
    {
      path: '/my-app',
      component: resolve => require(['../vivew/home/myApp'], resolve),
      meta: { index: 0 /*,scroll_top: true*/ }
    },
    {
      path: '/gpark',
    ...
    {
      path: '/goucai',
      component: resolve => require(['../vivew/my/goucai'], resolve),
      meta: { index: 'goucai' }
    },
    {
      path: '/My/gameApi',
      component: resolve => require(['../vivew/my/game/gameApi'], resolve),
      meta: { index: 'gameApi' }
    },
    {
      path: '/My/allCode', //获取所有彩票的最新一期开奖信息
      component: resolve => require(['../vivew/my/game/allCode'], resolve),
      meta: { index: 0 }
    },
    {
      path: '/My/hongbao',
      component: resolve => require(['../vivew/my/game/hongbao'], resolve),
      meta: { index: 'hongbao' }
    },
    {
      path: '/My/hongbaoRule',
      component: resolve => require(['../vivew/my/game/hongbaoRule'], resolve),
      meta: { index: 'hongbao' }
    },
    {
      path: '/My/hongbaoBang',
      component: resolve => require(['../vivew/my/game/hongbaoBang'], resolve),
      meta: { index: 'hongbao' }
    },
    {
      path: '/My/myhongbao',
      component: resolve => require(['../vivew/my/game/myhongbao'], resolve),
      meta: { index: 'hongbao' }
    },
    {
      path: '/trend/:id',
      component: resolve => require(['../vivew/home/common/trend'], resolve),
      meta: { index: 'showTrend' },
      children: []
    },
    {
      path: '/bjl/:id',
    ...
    {
      path: '/game-c-gf/:id',
      component: resolve => require(['../vivew/home/ks/official'], resolve),
      meta: { index: 12 },
      children: []
    },
    {
    ...
    {
      path: '/game-s-gf/:id',
      component: resolve => require(['../vivew/home/ssc/official'], resolve),
      meta: { index: 12 },
      children: []
    },
    {
    ...
    {
      path: '/game-x-gf/:id',
      component: resolve => require(['../vivew/home/syxw/official'], resolve),
      meta: { index: 12 },
      children: []
    },
    {
    ...
    {
      path: '/allNotice',
      component: resolve => require(['../vivew/discount/allNotice'], resolve),
      meta: { index: 11 ,title: '公告列表'},
      children: []
    },
    {
    ...
    {
      path: '/Trade',
      component: resolve => require(['../vivew/trade'], resolve),
      meta: { index: 'gameApi'},
      children: []
    },
    {
      path: '/findCentre',
      component: resolve => require(['../vivew/find/findCentre'], resolve),
      meta: { index: 'gameApi'},
      children: []
    },
    {
    ...
    },
    {
      ...
      meta: { index: 'memberCenter', auth: true },
      children: []
    },
    {
      path: '/My/promotion',
    ...
    },
    {
      ...
      meta: { index: 5,not_show:1, title: '会员登陆' }
    },
    {
      // 注册
      path: '/in/register/:u',
      component: resolve => require(['../vivew/in/register'], resolve),
      meta: { index: 6,not_show:1, title: '会员注册' }
    },
    {
      // 前台代理会员注册
      path: '/in/ReAgent/:u',
      component: resolve => require(['../vivew/in/agent'], resolve),
      meta: { index: 6,not_show:1, title: '注册通道' }
    },
    {
      // 密码找回
      path: '/in/back-password',
      component: resolve => require(['../vivew/in/backpwd'], resolve),
      meta: { index: 7 ,not_show:1,}
    },

    {
      path: '/With',
      component: resolve => require(['../vivew/with/index'], resolve),
      meta: { index: 'hmdt', title: '互动中心@合买大厅' },
      children: []
    },
    {
      // 互动中心
      path: '/my/chart/InteractiveCenter',
      component: resolve => require(['../vivew/my/chart/InteractiveCenter'], resolve),
      meta: { index: 'hddt' ,title: '互动中心@合买大厅' }
    },
    {
      // 私人聊天
      path: '/my/chart/chatroom/:id/',
      component: resolve => require(['../vivew/my/chart/chatroom'], resolve),
      meta: { index: 5 ,title: '私人聊天' }
    },
    {
      // 好友列表
      path: '/friend',
      component: resolve => require(['../vivew/my/friend/index'], resolve),
      meta: {index:7,title:'好友列表'}
    },
    {
      //群规置
      path: '/my/chart/Regulation/:chart_id',
      component: resolve => require(['../vivew/my/chart/setchart'], resolve),
      meta: { index: 5 ,title: '群规置' }
    },
  ]
});
